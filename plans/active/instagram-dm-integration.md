...
export const instagramKeys = {
  ...
  conversations: (integrationId) => [...instagramKeys.all, 'conversations', integrationId],
  messages: (conversationId) => [...instagramKeys.all, 'messages', conversationId],
  scheduled: (conversationId) => [...instagramKeys.all, 'scheduled', conversationId],
