...
## [Checkpoint] - 2025-12-04 15:13:10
...
## [Checkpoint] - 2025-12-04 14:24:26
...
### Changed Files
- `package-lock.json`
- `plans/ACTIVE/consolidated-admin-and-user-management-system.md`
- `plans/ACTIVE/email-system-phase-2-tiptap-wysiwyg-composer.md`
- `plans/ACTIVE/kpi_redesign_three_layouts.md`
- `plans/COMPLETED/admin-role-based-filtering-fix-2025-11-28.md`
...
### Statistics
```
 19 files changed, 1224 insertions(+), 1110 deletions(-)
```
...
## [Checkpoint] - 2025-11-28 18:14:36

### Changed Files
- `docs/ADMIN_FILTERING_FIX_PLAN.md`
- `scripts/fix-problem-users-data.sql`
...
### Changed Files
- `.serena/memories/ui_style_preferences.md`
- `src/features/admin/components/AdminControlCenter.tsx`
- `src/features/recruiting/RecruitingDashboard.tsx`
- `src/features/recruiting/components/PhaseChecklist.tsx`
- `src/services/admin/userApprovalService.ts`
...
### Statistics
```
 5 files changed, 476 insertions(+), 523 deletions(-)
```
...
## [Checkpoint] - 2025-11-19 11:01:38
