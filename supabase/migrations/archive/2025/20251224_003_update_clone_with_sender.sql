-- ============================================================================
-- Update Clone Pipeline Template to Include Sender Columns
-- ============================================================================

BEGIN;

-- Drop and recreate the clone function with sender columns
...
BEGIN
  ...
  LOOP
    ...
    -- Clone phase-level automations (including sender columns)
    FOR v_automation IN
    ...
    LOOP
      INSERT INTO pipeline_automations (
        ...
        v_automation.sender_type,
        v_automation.sender_email,
        v_automation.sender_name,
    ...
    LOOP
      ...
      -- Clone checklist item-level automations (including sender columns)
      FOR v_automation IN
        SELECT * FROM pipeline_automations
...
'Clones a pipeline template with all phases, checklist items, and automations (including sender configuration).
Parameters:
