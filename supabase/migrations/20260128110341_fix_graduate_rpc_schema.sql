-- supabase/migrations/20260128110341_fix_graduate_rpc_schema.sql
-- Fix: Use correct column names from actual schema

-- user_activity_log columns: action_type, details, performed_by, user_id
-- notifications columns: user_id, type, title, message, metadata, read
...
BEGIN
  ...
  -- Log the activity using correct column names: action_type, details, performed_by
