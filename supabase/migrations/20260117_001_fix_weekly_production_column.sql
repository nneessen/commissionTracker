-- supabase/migrations/20260117_001_fix_weekly_production_column.sql
-- Fix: Replace non-existent status_change_date with cancellation_date
-- The lapse_activity CTE was referencing p.status_change_date which doesn't exist
-- in the policies table. The correct column for tracking lapse timing is cancellation_date.

--------------------------------------------------------------------------------
-- Agency Weekly Production RPC (FIXED)
