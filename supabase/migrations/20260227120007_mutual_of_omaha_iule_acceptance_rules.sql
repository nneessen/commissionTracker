-- Mutual of Omaha IULE (Indexed Universal Life Express) acceptance rules
-- Product: Indexed Universal Life (simplified issue)
...
DECLARE
  ...
  v_product_type text := 'indexed_universal_life';
  v_count int := 0;
BEGIN
  ...
  RAISE NOTICE 'Mutual of Omaha IULE: inserted/updated % acceptance rules', v_count;
END $$;
