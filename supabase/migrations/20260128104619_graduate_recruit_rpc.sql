-- supabase/migrations/20260128104619_graduate_recruit_rpc.sql
-- RPC function to graduate a recruit to agent
-- Bypasses RLS with SECURITY DEFINER since uplines need to graduate their recruits
