...
-- Fix all leaderboards: AP should respect date filters using submit_date
--
-- Business Logic:
--   IP = Active policies with effective_date in range
--   AP = Pending policies with submit_date in range
...
-- Comments
COMMENT ON FUNCTION get_leaderboard_data IS 'Individual agent leaderboard. IP = active policies by effective_date in range. AP = pending policies by submit_date in range.';
COMMENT ON FUNCTION get_team_leaderboard_data IS 'Team leaderboard. IP = active policies by effective_date in range. AP = pending policies by submit_date in range.';
COMMENT ON FUNCTION get_agency_leaderboard_data IS 'Agency leaderboard. IP = active policies by effective_date in range. AP = pending policies by submit_date in range.';
