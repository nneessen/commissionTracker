-- Migration: Fix admin_delete_user to do HARD DELETE instead of soft delete
-- Problem: Soft delete was leaving rows in user_profiles, blocking email unique constraint
-- Solution: Actually delete the user and all related data
