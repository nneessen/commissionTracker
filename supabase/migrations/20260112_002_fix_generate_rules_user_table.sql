...
-- Fix: Replace 'users' with 'user_profiles' in generate rules RPC functions

-- =============================================================================
-- FUNCTION: Generate Global Knockout Rule Sets (FIXED)
-- =============================================================================
...
BEGIN
  ...
  -- Verify user has access to this IMO (FIXED: use user_profiles instead of users)
  IF NOT EXISTS (
...
-- =============================================================================
-- FUNCTION: Generate Age Rules from Products (FIXED)
-- =============================================================================
