-- supabase/migrations/20260113_001_fix_rpc_auth_table.sql
-- Purpose: Fix RPC authorization - change `users` to `user_profiles` table
-- Issue: RPCs were referencing non-existent `users` table instead of `user_profiles`

-- =============================================================================
-- FIX: generate_global_knockout_rules - correct table reference
-- =============================================================================
...
BEGIN
  ...
  -- Verify user has access to this IMO (FIXED: user_profiles instead of users)
  IF NOT EXISTS (
...
-- =============================================================================
-- FIX: generate_age_rules_from_products - correct table reference
-- =============================================================================
...
COMMENT ON FUNCTION generate_global_knockout_rules IS
  'Generate draft global knockout rule sets for a carrier based on predefined knockout conditions. Fixed to use user_profiles table.';

COMMENT ON FUNCTION generate_age_rules_from_products IS
  'Generate draft age eligibility rule sets for a carrier based on product min_age/max_age. Fixed to use user_profiles table.';
