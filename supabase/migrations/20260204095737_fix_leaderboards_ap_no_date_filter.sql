...
-- Fix all leaderboards: AP should be ALL pending policies, no date filter
--
-- Business Logic:
...
-- Comments
COMMENT ON FUNCTION get_leaderboard_data IS 'Individual agent leaderboard. IP = active policies by effective_date in range. AP = ALL pending policies (no date filter).';
COMMENT ON FUNCTION get_team_leaderboard_data IS 'Team leaderboard. IP = active policies by effective_date in range. AP = ALL pending policies (no date filter).';
COMMENT ON FUNCTION get_agency_leaderboard_data IS 'Agency leaderboard. IP = active policies by effective_date in range. AP = ALL pending policies (no date filter).';
