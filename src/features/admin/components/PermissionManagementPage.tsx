...
import { Loader2, Plus, Pencil, Trash2, Shield, Search, Lock } from "lucide-react";
        ...
        <Select value={resourceFilter} onValueChange={setResourceFilter}>
          ...
          <SelectContent>
            ...
            {uniqueResources.map((resource) => (
              <SelectItem key={resource} value={resource} className="text-[11px]">
                {resource}
              </SelectItem>
            ))}
          </SelectContent>
