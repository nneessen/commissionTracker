...
const REPORT_CATEGORIES = {
  executive: {
    ...
    reports: [
      {
        type: "executive-dashboard" as ReportType,
        name: "Executive Report",
        icon: "📊",
      },
      {
        type: "financial-health" as ReportType,
        name: "Financial Health",
        icon: "💰",
      },
      {
        type: "predictive-analytics" as ReportType,
  ...
  performance: {
    ...
    reports: [
      {
        type: "commission-performance" as ReportType,
        name: "Commission Report",
        icon: "💵",
      },
      {
        type: "policy-performance" as ReportType,
        name: "Policy Report",
        icon: "📋",
      },
      {
        type: "client-relationship" as ReportType,
        name: "Client Report",
        icon: "👥",
      },
    ],
...
export function ReportsPage() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col bg-zinc-50 dark:bg-zinc-950">
      {/* Top Bar */}
      <div className="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 px-3 py-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-1.5">
              ...
              <Button
                ...
                size="sm"
                variant="ghost"
                className="h-7 px-2.5 text-xs bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 dark:text-blue-400"
              >
            ...
            {!isLoading && !error && report && (
              <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800">
                ...
                <div className="px-3 py-2 border-b border-zinc-200 dark:border-zinc-800">
                  ...
                  {report.summary.topInsights.length > 0 && (
                    <div className="space-y-2">
                      <h3 className="text-xs font-semibold text-zinc-900 dark:text-zinc-100 mb-1.5">
                        Priority Actions
                      </h3>
                      {report.summary.topInsights.map((insight, _index) => (
                        <div
                          key={insight.id}
                          className="flex items-start gap-2 p-2 rounded-sm bg-amber-500/10 border-l-2 border-l-amber-500"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-zinc-900 dark:text-zinc-100 font-medium mt-0.5">
                ...
                {report.sections.map((section, _sectionIndex) => (
                  <div
                    key={section.id}
                    className="px-3 py-2 md:py-3 border-b border-zinc-200 dark:border-zinc-800 last:border-b-0"
                  >
                      ...
                      <div className="mb-3 space-y-1">
                        ...
                        <div className="p-2 bg-zinc-50 dark:bg-zinc-800/50 rounded border border-zinc-200 dark:border-zinc-700">
                          ...
                          <div className="h-40 flex items-center justify-center text-zinc-500 dark:text-zinc-400 text-xs">
                            ...
                            {section.chartData.datasets.length} datasets)
                          </div>
                        </div>
                      </div>
                    )}
                ...
                {/* Report Footer */}
                <div className="p-2 bg-zinc-50 dark:bg-zinc-800/50 text-center border-t border-zinc-200 dark:border-zinc-700">
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
