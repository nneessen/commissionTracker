...
const REPORT_TYPES: Array<{
  ...
  },
  {
    ...
    description:
      "Detailed commission analysis by carrier, product, and time period",
    icon: DollarSign,
  },
  {
    ...
    description:
      "Persistency analysis, lapse patterns, and policy health metrics",
    icon: FileText,
  },
  {
    ...
    description:
      "Client segmentation, cross-sell opportunities, and LTV analysis",
    icon: Users,
  },
  {
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h3
                  className={`font-semibold text-sm mb-1 ${isSelected ? "text-primary" : "text-foreground"}`}
                >
                  {reportType.label}
                </h3>
