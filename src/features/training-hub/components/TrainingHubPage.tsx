      ...
      <div className="flex items-center justify-between bg-white dark:bg-zinc-900 rounded-lg px-3 py-2 border border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Training Hub</h1>
          </div>
          ...
          <div className="flex items-center gap-3 text-[11px]">
            <div className="flex items-center gap-1">
              ...
              <span className="font-medium text-zinc-900 dark:text-zinc-100">{recruitStats?.inProgress || 0}</span>
              <span className="text-zinc-500 dark:text-zinc-400">recruits</span>
            </div>
            <div className="h-3 w-px bg-zinc-200 dark:bg-zinc-700" />
            <div className="flex items-center gap-1">
              <Mail className="h-3 w-3 text-blue-500" />
              <span className="font-medium text-zinc-900 dark:text-zinc-100">{templateStats?.count || 0}</span>
              <span className="text-zinc-500 dark:text-zinc-400">templates</span>
            </div>
          </div>
        </div>
