    ...
    <div className="flex items-center gap-1 py-0.5 text-[8px]">
      ...
      {action.type === "send_email" && (
        <Select
          ...
          onValueChange={(v) =>
            onUpdate({ config: { ...action.config, templateId: v } })
          }
        >
      ...
      {action.type === "create_notification" && (
        <Input
          ...
          onChange={(e) =>
            onUpdate({ config: { ...action.config, title: e.target.value } })
          }
          className="h-5 text-[8px] flex-1"
          placeholder="Title..."
        />
...
export default function WorkflowDialog({
  ...
  const groupedEvents = triggerEventTypes.reduce(
    (acc, event) => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- form.reset is stable, only re-run when workflow identity changes
  }, [open, workflow?.id]);
      ...
      <DialogContent className="max-w-md max-h-[85vh] overflow-hidden flex flex-col p-2">
        ...
        >
              ...
              <form.Field name="category">
                {(field) => (
                  <Select
                    value={field.state.value}
                    onValueChange={(v) =>
                      field.handleChange(v as WorkflowCategory)
                    }
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="email" className="text-[8px]">
                        Email
                      </SelectItem>
                      <SelectItem value="recruiting" className="text-[8px]">
                        Recruit
                      </SelectItem>
                      <SelectItem value="commission" className="text-[8px]">
                        Comm
                      </SelectItem>
                      <SelectItem value="general" className="text-[8px]">
                        General
                      </SelectItem>
                    </SelectContent>
                  </Select>
              ...
              <form.Field name="triggerType">
                {(field) => (
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="manual" className="text-[8px]">
                        Manual
                      </SelectItem>
                      <SelectItem value="schedule" className="text-[8px]">
                        Schedule
                      </SelectItem>
                      <SelectItem value="event" className="text-[8px]">
                        Event
                      </SelectItem>
                      <SelectItem value="webhook" className="text-[8px]">
                        Webhook
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  ...
                  <form.Field name="trigger.schedule.dayOfWeek">
                    {(field) => (
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="daily" className="text-[8px]">
                            Daily
                          </SelectItem>
                          <SelectItem value="monday" className="text-[8px]">
                            Mon
                          </SelectItem>
                          <SelectItem value="tuesday" className="text-[8px]">
                            Tue
                          </SelectItem>
                          <SelectItem value="wednesday" className="text-[8px]">
                            Wed
                          </SelectItem>
                          <SelectItem value="thursday" className="text-[8px]">
                            Thu
                          </SelectItem>
                          <SelectItem value="friday" className="text-[8px]">
                            Fri
                          </SelectItem>
                          <SelectItem value="saturday" className="text-[8px]">
                            Sat
                          </SelectItem>
                          <SelectItem value="sunday" className="text-[8px]">
                            Sun
                          </SelectItem>
                        </SelectContent>
                      </Select>
          ...
          <div className="space-y-0.5">
            ...
            {actions.length === 0 ? (
              <p className="text-[8px] text-muted-foreground py-1">
                No actions
              </p>
            ) : (
              ...
              <form.Field name="settings.maxRunsPerDay">
                {(field) => (
                  <Input
                    ...
                    value={field.state.value}
                    onChange={(e) =>
                      field.handleChange(parseInt(e.target.value) || 50)
                    }
