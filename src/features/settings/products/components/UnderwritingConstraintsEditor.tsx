        ...
        <div className="space-y-2 rounded-md border border-zinc-200 dark:border-zinc-700 p-2">
          ...
          {ageTiers.length === 0 ? (
            ...
            <div className="space-y-1.5">
              <div className="grid grid-cols-[1fr_1fr_1fr_24px] gap-1 text-[9px] font-medium text-zinc-500 uppercase">
                <span>Min Age</span>
                <span>Max Age</span>
        ...
        <div className="space-y-2 rounded-md border border-zinc-200 dark:border-zinc-700 p-2">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Label className="text-[10px] text-zinc-500 w-24">
                Base Threshold:
              </Label>
              <Input
                type="number"
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[300px] p-0" align="start">
        <Command>
          ...
          />
          <CommandList>
            <CommandEmpty className="text-[11px] py-4 text-center text-zinc-500">
              No conditions found.
            </CommandEmpty>
