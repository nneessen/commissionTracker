        ...
        <div className="p-3">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] text-zinc-400 mb-2">{getFieldDescription('avgAP')}</p>
      ...
      <div className="bg-amber-50 dark:bg-amber-950/30 rounded-lg border border-amber-200 dark:border-amber-800 p-3">
        <div className="flex items-start gap-2">
          ...
          <div className="text-[10px]">
            <p className="font-medium text-amber-700 dark:text-amber-300 mb-0.5">About Premium Override</p>
