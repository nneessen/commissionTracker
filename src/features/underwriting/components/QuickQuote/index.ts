...
export { QuickQuoteDialog, QuickQuoteDialog as QuickQuotePage } from "./QuickQuoteDialog";
...
export { QuickOptionsPresets, TERM_COVERAGE_PRESETS, PERM_COVERAGE_PRESETS } from "./quick-options-presets";
