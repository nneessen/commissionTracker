  ...
  const handleAddDownline = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (downline.upline_id) {
        setError(`${downline.email} already has an upline. They need to remove it first.`);
        return;
      }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Send this link to potential team members. When they sign up, you'll be set as their upline automatically.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            <p className="text-sm text-muted-foreground">
              💡 <strong>Tip:</strong> Send this link via email, text, or social media. When someone
              signs up using this link, they'll automatically be added to your team.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            If someone already has an account, you can add them to your team by email.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleAddDownline} className="space-y-4">
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              <p className="text-sm text-muted-foreground">
                ℹ️ <strong>Note:</strong> The user must not already have an upline. If they do, they'll
                need to remove their current upline in Settings first.
              </p>
            </div>
          </form>
        </CardContent>
