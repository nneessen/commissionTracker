...
const SANITIZE_CONFIG = {
  ALLOWED_TAGS: ['p', 'br', 'b', 'i', 'strong', 'em', 'u', 'a', 'ul', 'ol', 'li', 'span'],
    ...
    <div className="p-1.5">
      ...
      <div className="mb-1.5 flex items-center gap-0.5 border-b pb-1.5">
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className={cn('h-6 w-6', editor?.isActive({ textAlign: 'left' }) && 'bg-muted')}
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className={cn('h-6 w-6', editor?.isActive({ textAlign: 'center' }) && 'bg-muted')}
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className={cn('h-6 w-6', editor?.isActive({ textAlign: 'right' }) && 'bg-muted')}
