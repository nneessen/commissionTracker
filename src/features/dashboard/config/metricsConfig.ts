  ...
  return [
    {
      ...
      current: scaleToDisplayPeriod(periodCommissions.earned, timePeriod),
      target: null,
      unit: '$',
      showTarget: false,
    },
    {
      ...
      current: scaleCountToDisplayPeriod(periodPolicies.newCount, timePeriod),
      target: null,
      unit: '#',
      showTarget: false,
    },
    {
      ...
      current: scaleToDisplayPeriod(periodPolicies.premiumWritten, timePeriod),
      target: null,
      unit: '$',
      showTarget: false,
    },
    {
      ...
      current: scaleCountToDisplayPeriod(periodClients.newCount, timePeriod),
      target: null,
      unit: '#',
      showTarget: false,
    },
    ...
    },
    {
      ...
      current: scaleToDisplayPeriod(periodExpenses.total, timePeriod),
      target: null,
      unit: '$',
      showTarget: false,
    },
    {
      ...
      current: scaleToDisplayPeriod(periodAnalytics.netIncome, timePeriod),
      target: null,
      unit: '$',
      showTarget: false,
    },
