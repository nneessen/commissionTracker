    ...
    <Card className="bg-gradient-to-br from-card via-primary/5 to-card mb-6 shadow-xl">
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
          ...
          <div className="bg-gradient-to-br from-success/20 via-status-active/15 to-card shadow-md rounded-lg p-4">
            <div className="text-xs text-muted-foreground mb-2 uppercase tracking-wide font-semibold">
          ...
          <div className="bg-gradient-to-br from-warning/20 via-status-pending/15 to-card shadow-md rounded-lg p-4">
            <div className="text-xs text-muted-foreground mb-2 uppercase tracking-wide font-semibold">
              Average AP
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
          <div className="bg-gradient-to-br from-accent/10 to-card shadow-md rounded-lg p-3 flex items-center gap-3">
