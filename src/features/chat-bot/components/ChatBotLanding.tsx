...
export function ChatBotLanding() {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="p-3 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-lg border border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400">
              ...
              books appointments on your calendar. Works 24/7.
              <span className="font-medium text-zinc-600 dark:text-zinc-300">
                {" "}
                Close CRM + Calendly only.
              </span>
            </p>
          </div>
        </div>
      ...
      <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        ...
        <div className="px-5 py-4 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
          ...
          <p className="text-[11px] text-zinc-400 mt-0.5">
            Pick the plan that fits your lead volume and goals.
          </p>
        </div>
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
                {[
                  ...
                  { name: "Growth", price: "$99", leads: "150", popular: true },
                  {
                    name: "Scale",
                    price: "$199",
                    leads: "500",
      ...
      {/* ═══════════ REQUIREMENTS ═══════════ */}
      <div className="p-3 border border-amber-200 dark:border-amber-800/50 bg-amber-50/50 dark:bg-amber-950/10 rounded-lg">
        <div className="flex items-center gap-1.5 mb-2">
          <AlertTriangle className="h-3 w-3 text-amber-500" />
          <h2 className="text-[10px] font-medium uppercase tracking-wide text-amber-700 dark:text-amber-400">
            Before You Get Started
          </h2>
        </div>
        <p className="text-[10px] text-zinc-600 dark:text-zinc-400 mb-2.5">
          ...
          . Google Calendar support is coming next, followed by additional CRMs.
          Make sure you have the following ready:
        </p>
        <div className="space-y-2">
          <div className="flex items-start gap-2 p-2 bg-white dark:bg-zinc-900 rounded-md border border-zinc-200/50 dark:border-zinc-800/50">
            ...
            <div>
              ...
              <ul className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5 space-y-0.5">
                <li>Must have a custom field called "Lead Source" on leads</li>
          ...
          <div className="flex items-start gap-2 p-2 bg-white dark:bg-zinc-900 rounded-md border border-zinc-200/50 dark:border-zinc-800/50">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">
                Know which lead sources your leads come from (e.g. "Sitka Life",
                "GOAT Realtime Mortgage"). You'll configure these after
                subscribing.
              </p>
            </div>
          </div>
      ...
      <div className="p-3 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg">
        <h2 className="text-[10px] font-medium uppercase tracking-wide text-zinc-500 dark:text-zinc-400 mb-2.5">
          How It Works
        </h2>
        <div className="grid grid-cols-3 gap-2">
          <div className="p-2.5 rounded-lg bg-blue-50 dark:bg-blue-950/30">
            ...
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">
              A new lead sends an SMS to your Close CRM phone number
            </p>
          </div>
          <div className="p-2.5 rounded-lg bg-purple-50 dark:bg-purple-950/30">
            ...
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">
              The bot replies within seconds, has a natural back-and-forth
              conversation, and offers appointment times
            </p>
          </div>
          <div className="p-2.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/30">
            ...
            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5">
              A Calendly event is created on your calendar and both you and the
              lead are notified
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            },
            {
              ...
              desc: "Customizes its messaging based on whether the lead came from mortgage protection, veteran, or other sources",
            },
            {
              icon: MessageSquare,
            ...
            <div
              key={f.title}
              className="p-2 bg-zinc-50 dark:bg-zinc-800/50 rounded-md"
            >
              <div className="flex items-center gap-1.5 mb-1">
                <f.icon className="h-3 w-3 text-zinc-400 flex-shrink-0" />
      ...
      <div className="p-3 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg">
        ...
        <div className="flex items-center gap-4 mb-2">
          <div className="flex items-center gap-2 px-3 py-2 bg-zinc-50 dark:bg-zinc-800/50 rounded-md flex-1">
        ...
        <div className="flex items-center gap-2 text-[10px] text-zinc-400 dark:text-zinc-500 border-t border-zinc-100 dark:border-zinc-800 pt-2">
