  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          <AlertDialogTitle>Change Status for {selectedCount} Contracts</AlertDialogTitle>
          <AlertDialogDescription>
            Select the new status to apply to all selected contract requests.
          </AlertDialogDescription>
        </AlertDialogHeader>

        <RadioGroup value={selectedStatus} onValueChange={setSelectedStatus} className="space-y-2 py-4">
