...
import type {Commission, CommissionClientInfo} from '../commission.types';

/**
 * @deprecated Use CommissionClientInfo from commission.types.ts
 * This was the original name before standardization
 */
export type LegacyClient = CommissionClientInfo;
 ...
 */
export function migrateLegacyCommission(legacy: Partial<LegacyCommission>): Partial<Commission> {
