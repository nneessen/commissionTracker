  ...
  return (
    <div style={{ padding: "20px", fontFamily: "monospace" }}>
      ...
      <ul>
        ...
        <li>
          Can access Team Dashboard: {can("nav.team_dashboard") ? "✅" : "❌"}
        </li>
        <li>
          Can access Recruiting: {can("nav.recruiting_pipeline") ? "✅" : "❌"}
        </li>
      </ul>
      ...
      <div
        style={{
          marginTop: "20px",
          padding: "10px",
          background: userInfo?.roles?.includes("active_agent")
            ? "#d4f4dd"
            : "#fdd4d4",
        }}
      >
        <strong>Status: </strong>
        {userInfo?.roles?.includes("active_agent") &&
        userInfo?.agent_status === "licensed" &&
        userInfo?.approval_status === "approved"
