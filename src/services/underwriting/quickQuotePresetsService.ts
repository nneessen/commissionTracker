...
type Insert = Database["public"]["Tables"]["user_quick_quote_presets"]["Insert"];
...
export const quickQuotePresetsService = {
  ...
  async upsertPresets(
    ...
    if (presets.coveragePresets !== undefined) {
      upsertData.coverage_presets = presets.coveragePresets as unknown as Insert["coverage_presets"];
    }
    if (presets.budgetPresets !== undefined) {
      upsertData.budget_presets = presets.budgetPresets as unknown as Insert["budget_presets"];
    }
